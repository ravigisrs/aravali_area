...
(function(document, window) {
    ...
    JXSlider.prototype = {
        ...
        displayCredits: function() {
            ...
            text = "<em></em>";
            if (this.imgBefore.credit) { text += " <em></em> " + this.imgBefore.credit; }
            if (this.imgAfter.credit) { text += " <em></em> " + this.imgAfter.credit; }
        ...
        _onLoaded: function() {
            ...
            if (this.imgBefore && this.imgBefore.loaded === true &&
                ...
                setText(this.projectName, 'GIS-Cell,HSPCB');
